  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-gray-200 bg-transparent">
      ...
      >
        ...
        <p className="mt-6 text-sm font-semibold text-gray-300">Upload Resume</p>
        <input
        ...
        <p className="text-xs text-gray-500 font-light mt-1">Supports PDF only</p>

        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00da83] to-[#009bb3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:opacity-90"
        >
          {loading ? (
      ...
      {/* Right Column */}
      <div className="w-full max-w-lg p-4 bg-[#1a1a1a] rounded-lg flex flex-col border border-gray-700 min-h-96 max-h-[600px] shadow-md">
        <div className="flex items-center gap-3">
