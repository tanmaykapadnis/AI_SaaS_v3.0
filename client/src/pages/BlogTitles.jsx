  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-gray-200 bg-transparent">
      ...
      >
        ...
        <p className="mt-6 text-sm font-semibold text-gray-300">Keyword</p>
        <input
        ...
        <button
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-400 text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer hover:opacity-90"
        >
          {loading ? (
